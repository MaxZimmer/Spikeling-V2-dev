...
"}")
        ...
        self.label.setPixmap(QPixmap(u":/resources/resources/LogoLight3D.png"))
        ...
        self.Sussex_Logo.setMaximumSize(QSize(120, 30))
        ...
        self.TReND_Logo.setMaximumSize(QSize(50, 30))
