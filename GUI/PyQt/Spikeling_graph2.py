...
def ReadSerial(self):
    ...
    def updateplot():
        ...
        if self.ui.Spikeling_Synapse2_Decay_checkBox.isChecked():
            ...
            #SerialTx[17] = "T"
            #self.ui.Sound_pushButton.setIcon(u":/resources/resources/SoundOFF.png")
        #else:
            #SerialTx[17] = "F"
            #self.ui.Sound_pushButton.setIcon(u":/resources/resources/SoundON.png")


        data = getdata()

        if self.ui.Spikeling_VmCheckbox.isChecked():
            self.databuffer0.append(data[0])
        ...
        if self.ui.Spikeling_Syn2InputCheckbox.isChecked():
            self.databuffer6.append(data[6])
